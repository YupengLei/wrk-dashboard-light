...
export const homePageData = [
    {
        ...
        statsLink: "/wrk-dashboard-light/housing",
        element: <Housing />,
        statsContent: [
            {
                statsID: 0,
    ...
    },
    {
        ...
        statsLink: "/wrk-dashboard-light/education",
        element: <Education />,
        statsContent: [
            {
                statsID: 0,
    ...
    },
    {
        ...
        statsLink: "/wrk-dashboard-light/workforce",
        element: <Workforce />,
        statsContent: [
            {
                statsID: 0,
    ...
    },
    {
        ...
        statsLink: "/wrk-dashboard-light/safety",
        element: <Safety />,
        statsContent: [
            {
                statsID: 0,
    ...
    },
    {
        ...
        statsLink: "/wrk-dashboard-light/events",
        element: <Events />,
        statsContent: [
            {
                statsID: 0,
