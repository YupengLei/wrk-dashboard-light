...
import mathData from "../../data/education_achievement_wide_math.csv";
...
export default class Math extends React.Component {
    ...
    drawMath = () => {
        ...
        d3.csv(mathData).then(data => {
            ...
            //create svg element
            let svg = d3.select(this.props.mathRef.current)
                        .append("svg")
                        .attr("width", w)
                        .attr("height", h); 
            ...
            rect.on("mouseover", (event, d) => {
                    ...
                    d3.select("#math").classed("hidden", false);
                ...
                .on("mouseout", (event, d) => {
                    ...
                    d3.select("#math").classed("hidden", true);
                });
    ...
    render() {
        return (
            <div className="math-gap" style={{display: this.props.selectedStatsID === 2 ? "block" : "none"}}>
                <ChartHeader 
                    chartTitle="3rd - 8th graders achieving math proficiency"
                    dotColor="#e7298a"
                />
                <ChartContainer 
                    containerRef={this.props.mathRef} 
                    tooltipID="math"
